...
namespace Obydul\Larable\Follow\Traits;
...
trait Follower
{
    ...
    public function follow(Model $followable): array
    {
        ...
        /** @var \Illuminate\Database\Eloquent\Model|\Obydul\Larable\Follow\Traits\Followable $followable */
    ...
    {
        if (! in_array(\Obydul\Larable\Follow\Traits\Followable::class, \class_uses($followable))) {
            throw new InvalidArgumentException('The followable model must use the Followable trait.');
        }
